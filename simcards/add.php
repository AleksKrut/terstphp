...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $sql = "INSERT INTO sim_cards (number, client, car_number, terminal, system, status, operator, tab) 
            ...
            <div class="col-lg-6 col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="card-title"><i class="bi bi-plus-circle me-2"></i>Добавить SIM-карту</h4>
                    </div>
                    <div class="card-body">
                        <?php if(isset($error)): ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="tab" name="tab" required>
                                    <?php foreach($tabs as $tab): ?>
                                        <option value="<?= $tab ?>" <?= $tab === 'Основная' ? 'selected' : '' ?>>
                                            <?= $tab ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
